object Form1: TForm1
  ...
  Width = 1608
  Height = 1208
  Caption = 'Plateforme mobile OSCAR optimis'#233'e en 1280x1024'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBoxPlat: TGroupBox
      Left = 8
      Top = 328
      Width = 241
      Height = 369
      Caption = 'Plateau mobile'
      Color = clBtnFace
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
    ...
    object GroupBoxAsser: TGroupBox
      ...
      object CheckBoxAsser: TCheckBox
        Left = 0
        Top = 40
        Width = 17
        Height = 17
        TabOrder = 10
        OnClick = CheckBoxAsserClick
      end
      object CheckBoxAsserDr: TCheckBox
        Left = 0
        Top = 24
        Width = 17
        Height = 17
  ...
  object StatusBar1: TStatusBar
    ...
    Panels = <
      item
        Text = 'Pierre LEMERLE 13/01/2009'
        Width = 150
      end
      item
        Text = 'blackbird-dream@wanadoo.fr'
        Width = 50
      end>
    SimplePanel = False
  ...
  object RSTimer2: TRSTimer
    Left = 216
    Top = 72
    Width = 32
    Height = 32
    OnTimer = RSTimer2Timer
    ControlData = {010002004F0300004F03000040000000000300000001}
  end
  object RSTimer3: TRSTimer
    Left = 216
    Top = 104
    Width = 32
    Height = 32
    OnTimer = RSTimer3Timer
    ControlData = {010002004F0300004F03000040000000000300000001}
  end
  ...
  object TimeAsserGl1: TAsyncTimer
    Interval = 10
    OnTimer = TimeAsserGl1Timer
    ThreadPriority = tpNormal
    Left = 184
    Top = 40
  end
  object TimeAsserGl2: TAsyncTimer
    Interval = 10
    OnTimer = TimeAsserGl2Timer
    ThreadPriority = tpNormal
    Left = 184
    Top = 72
  end
  object TimeAsserGl3: TAsyncTimer
    Interval = 10
    OnTimer = TimeAsserGl3Timer
    ThreadPriority = tpNormal
    Left = 184
    Top = 104
  end
  object TimerParc: TTimer
    Enabled = False
    Interval = 20
    OnTimer = TimerParcTimer
    Left = 48
    Top = 208
  end
end
