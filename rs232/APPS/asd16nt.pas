...
function ascAbort; external 'ASD16';
function ascDriver; external 'ASD16';
function ascGetMessage; external 'ASD16';
function ascGetParameter; external 'ASD16';
function ascInit; external 'ASD16';
function ascStartTx; external 'ASD16';
function ascStartRx; external 'ASD16';
