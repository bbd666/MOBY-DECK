...
function xyAcquire; external 'XYM16';
function xyRelease; external 'XYM16';
function xyAbort; external 'XYM16';
function xyDebug; external 'XYM16';
function xyDriver; external 'XYM16';
function xyGetMessage; external 'XYM16';
function xyGetFileName; external 'XYM16';
function xyGetParameter; external 'XYM16';
function xySetParameter; external 'XYM16';
function xyStartTx; external 'XYM16';
function xyStartRx; external 'XYM16';
function xySetString; external 'XYM16';
end.
