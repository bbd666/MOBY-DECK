...
{WSC16NT.PAS, Version 4.4.0, Win16 Delphi}
...
function SioBrkSig; external 'WSC16';
...
function SioTimer; external 'WSC16';
function SioTxClear; external 'WSC16';
function SioTxQue; external 'WSC16';
function SioUnGetc; external 'WSC16';
function SioKeyCode; external 'WSC16';
function SioGetReg; external 'WSC16'; 
function SioSetInteger; external 'WSC16';
